    ...
    <web-layout>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 pt-5">
            <div class="flex flex-col gap-1 sm:gap-2 md:gap-3 lg:gap-4">
                ...
                <div class="flex px-3 gap-2 cursor-pointer hover:scale-90" v-for="(cat,i) in 5" :key="i">
            ...
            <div class="sm:col-span-3 md:col-span-4 lg:col-span-5 grid grid-cols-1 md:grid-cols-3 gap-2">
                <div class="md:col-span-2 px-3">
                    <div class="rounded-lg shadow-lg pt-3 grid gap-2 border divide-y mb-5" v-for="(blog,i) in blog" :key="i">
                        ...
                        <div class="divide-y">
                            ...
                            <div class="" v-if="!blog.show_comment" >
                                <div class="p-3 bg-gray-300 relative">
                ...
                <div class=" px-3">
                    ...
                    <div class="flex flex-col gap-3">
                        <div class="px-3 py-2 shadow-lg rounded-lg border flex gap-2" v-for="(blog,i) in 5" :key="i">
                            ...
                            <div class="flex-grow">
                                <div class="flex w-full h-full items-center">
                                    <div class="w-full">
                                        ...
                                        <div class=" overflow-ellipsis"> rfgwerf erferfe erferf erferf erf </div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default {
  components: { WebLayout },
    data(){
        return{
            blog:[{
                author:'ebube roderick',
                time:'30 minutes ago',
                content:`Lorem ipsum dolor sit amet consectetur, adipisicing elit. Reiciendis, corrupti? Atque laboriosam itaque quod voluptatum, illum nam consequuntur esse maxime inventore doloremque nobis alias saepe recusandae accusamus reprehenderit eveniet. Aliquid!
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Reiciendis, corrupti? Atque laboriosam itaque quod voluptatum, illum nam consequuntur esse maxime inventore doloremque nobis alias saepe recusandae accusamus reprehenderit eveniet. Aliquid!
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Reiciendis, corrupti? Atque laboriosam itaque quod voluptatum, illum nam consequuntur esse maxime inventore doloremque nobis alias saepe recusandae accusamus reprehenderit eveniet. Aliquid!
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Reiciendis, corrupti? Atque laboriosam itaque quod voluptatum, illum nam consequuntur esse maxime inventore doloremque nobis alias saepe recusandae accusamus reprehenderit eveniet. Aliquid!
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Reiciendis, corrupti? Atque laboriosam itaque quod voluptatum, illum nam consequuntur esse maxime inventore doloremque nobis alias saepe recusandae accusamus reprehenderit eveniet. Aliquid!
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Reiciendis, corrupti? Atque laboriosam itaque quod voluptatum, illum nam consequuntur esse maxime inventore doloremque nobis alias saepe recusandae accusamus reprehenderit eveniet. Aliquid!
